...
<div class="container">
    ...
    <form action="{{ route('students.update', $student->id) }}" method="POST">
        ...
        <div class="row">
            ...
            @endif
            <!-- Select Existing User (optional to reassign) -->
            <div class="col-md-12 mb-3">
                <label>Student User</label>
                <select name="user_id" class="form-control">
                    <option value="{{ $student->user_id }}">Current: {{ $student->user->name }} ({{ $student->user->email }})</option>
            ...
            <div class="col-md-12 mb-3">
                ...
                <select name="parent_ids[]" class="form-control" multiple>
                    @foreach($parents as $parent)
                        <option value="{{ $parent->id }}" {{ in_array($parent->id, old('parent_ids', $student->parents->pluck('id')->toArray())) ? 'selected' : '' }}>
